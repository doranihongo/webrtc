...
purify.setConfig({
  ...
  ALLOWED_URI_REGEXP:
    /^(?!\s*(?:data|javascript|vbscript|file|view-source)\s*:)/i, // Disallow dangerous URIs (case-insensitive, ignores leading whitespace)
});
...
function sanitizeData(data) {
  if (typeof data === "string") {
    ...
    const decodedData = needsDecoding(data)
      ? he.decode(safeDecodeURIComponent(data))
      : he.decode(data);
